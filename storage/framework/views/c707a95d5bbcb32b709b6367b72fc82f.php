                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="<?php echo e(route('register')); ?>" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="last_name" placeholder="<?php echo e(__('Last Name')); ?>" value="<?php echo e(old('last_name')); ?>" required>
                                    </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Prototype1\resources\views/auth/register.blade.php ENDPATH**/ ?>